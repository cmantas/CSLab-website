...
switch ($page) {
	case "lectures" :
		...
		include "$site_root/common/skeletons/course_material.php";
	...
	case "local_uploader":
        ...
        case "exercise_upload":
                include "$site_root/common/skeletons/course_exercise_upload.php";
                $content = ob_get_clean();
                break;
	default:
                if($page=="grades") $title_icon="icon-bar-chart";
...
function print_latest_material(){
	...
	echo "<div class='hero-unit span2 blocklist pull-right rightpanel' style:'min-height:250px;'>
